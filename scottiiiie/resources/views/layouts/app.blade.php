...
<head>
    ...
    <title>Scottiiiie!</title>

    <!-- Fonts -->
    <link href="{{ url('font-awesome.min.css') }}" rel='stylesheet' type='text/css'>
    <link href="{{ url('css?family=Lato:100,300,400,700') }}" rel='stylesheet' type='text/css'>
